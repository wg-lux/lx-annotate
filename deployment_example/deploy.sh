...
export LX_DTYPES_TERMINOLOGY_IMPORT_ROOT="${LX_DTYPES_TERMINOLOGY_IMPORT_ROOT:-$LX_ANNOTATE_ENCRYPTED_DATA_DIR/terminology/packages}"
...
"$VENV_DIR/bin/lx-dtypes-kb-registry" bootstrap \
