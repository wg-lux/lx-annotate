...
export LX_ANNOTATE_ENCRYPTED_DATA_DIR="${LX_ANNOTATE_ENCRYPTED_DATA_DIR:-${LX_ANNOTATE_DATA_DIR:-/var/lib/lx-annotate/data}}"
export LX_ANNOTATE_DATA_DIR="${LX_ANNOTATE_DATA_DIR:-$LX_ANNOTATE_ENCRYPTED_DATA_DIR}"
...
export STORAGE_DIR="${STORAGE_DIR:-$LX_ANNOTATE_ENCRYPTED_DATA_DIR/storage}"
export PROTECTED_MEDIA_ROOT="${PROTECTED_MEDIA_ROOT:-$STORAGE_DIR}"
export NGINX_PROTECTED_MEDIA_URL="${NGINX_PROTECTED_MEDIA_URL:-/protected_media/}"
export MEDIA_URL="${MEDIA_URL:-$NGINX_PROTECTED_MEDIA_URL}"
export LX_ANNOTATE_STREAMABLE_VIDEO_ROOT="${LX_ANNOTATE_STREAMABLE_VIDEO_ROOT:-$STORAGE_DIR/streamable_videos}"
export LX_ANNOTATE_STREAMABLE_VIDEO_RAW_ROOT="${LX_ANNOTATE_STREAMABLE_VIDEO_RAW_ROOT:-$LX_ANNOTATE_STREAMABLE_VIDEO_ROOT/raw}"
export LX_ANNOTATE_STREAMABLE_VIDEO_PROCESSED_ROOT="${LX_ANNOTATE_STREAMABLE_VIDEO_PROCESSED_ROOT:-$LX_ANNOTATE_STREAMABLE_VIDEO_ROOT/processed}"
