...
LX_ANNOTATE_HUB_EXPORT_REQUEST_TIMEOUT_SECONDS = int(
    os.getenv("LX_ANNOTATE_HUB_EXPORT_REQUEST_TIMEOUT_SECONDS", "21600"),
)
if LX_ANNOTATE_HUB_EXPORT_REQUEST_TIMEOUT_SECONDS <= 0:
    raise RuntimeError(
        "LX_ANNOTATE_HUB_EXPORT_REQUEST_TIMEOUT_SECONDS must be positive.",
    )
LX_ANNOTATE_HUB_EXPORT_STALE_AFTER_SECONDS = max(
    int(os.getenv("LX_ANNOTATE_HUB_EXPORT_STALE_AFTER_SECONDS", "25200")),
    60,
)
if (
