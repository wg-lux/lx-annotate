...
try:
    ...
    def get_random_secret_key(): return "bootstrapped_secret_key_change_me_immediately"
...
class EnvironmentSetup:
    def __init__(self, output_file: Path, force: bool = False, status_only: bool = False):
        ...
        self.defaults: Dict[str, Any] = {
            ...
            "OIDC_RP_CLIENT_SECRET": "changeme_oidc_secret",
            ...
            "DB_NAME": "lxAnnotateLocal",
            "DEV_DB_NAME": "lxAnnotateLocal",
            "TEST_DB_NAME": "lxAnnotateTest",
            "DB_USER": "lxAnnotateLocal",
    ...
    def run(self):
        ...
        try:
            with open(self.output_file, "w") as f:
                ...
                f.write("# DO NOT COMMIT THIS FILE IF IT CONTAINS REAL SECRETS\n\n")
                f.write("\n".join(new_lines))
                f.write("\n")
