        ...
        issues: [
            {
                ...
                level: 'warning',
                message: 'Validator size_mm_unit_when_large cannot evaluate its condition because required source data is missing: size_mm.',
            ...
            },
            {
                ...
                level: 'error',
                message: "Validator biopsy_required_when_large requires intervention 'biopsy' when condition is met.",
