...
function handleFetchData() {
    fetchSensitiveMetaData(false);
}
function handleLoadNextPatient() {
    loadNextPatient();
}
...
function __VLS_template() {
    ...
    if (__VLS_ctx.loading) {
        ...
        __VLS_elementAsFunction(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (__VLS_ctx.handleFetchData) },
    ...
    ['sensitive-meta-annotation', 'annotation-header', 'page-title', 'fas', 'fa-user-shield', 'patient-status', 'verified', 'pending', 'loading-container', 'spinner', 'error-container', 'fas', 'fa-exclamation-triangle', 'btn', 'btn-primary', 'fas', 'fa-redo', 'annotation-content', 'form-section', 'section-title', 'fas', 'fa-user', 'patient-form', 'form-row', 'form-group', 'form-label', 'required', 'fas', 'fa-user', 'form-input', 'error', 'error-message', 'form-group', 'form-label', 'required', 'fas', 'fa-user', 'form-input', 'error', 'error-message', 'form-row', 'form-group', 'form-label', 'required', 'fas', 'fa-calendar-alt', 'form-input', 'error', 'error-message', 'form-group', 'form-label', 'fas', 'fa-calendar-check', 'form-input', 'error', 'error-message', 'info-section', 'subsection-title', 'fas', 'fa-info-circle', 'info-grid', 'info-item', 'info-label', 'info-value', 'info-item', 'info-label', 'info-value', 'info-item', 'info-label', 'info-value', 'info-item', 'info-label', 'info-value', 'info-item', 'info-label', 'info-value', 'info-item', 'info-label', 'info-value', 'hash-value', 'form-actions', 'btn', 'btn-secondary', 'fas', 'fa-undo', 'btn', 'btn-info', 'fas', 'fa-forward', 'btn', 'btn-primary', 'fas', 'fa-spinner', 'fa-spin', 'fas', 'fa-save', 'media-section', 'section-title', 'fas', 'fa-video', 'media-preview', 'video-info', 'video-preview', 'no-data-container', 'fas', 'fa-inbox', 'btn', 'btn-primary', 'fas', 'fa-refresh', 'success-banner', 'fas', 'fa-check-circle',];
    var __VLS_slots;
    var $slots;
