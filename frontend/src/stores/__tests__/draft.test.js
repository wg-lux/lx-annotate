...
describe('Draft Store', () => {
    ...
    it('should save draft annotation', () => {
        ...
        expect(store.draftAnnotations[videoId]).toEqual(expect.arrayContaining([
    ...
    it('should persist drafts to localStorage', () => {
        ...
        store.saveDraft(videoId, annotation);
        expect(mockSetItem).toHaveBeenCalledWith('lx-annotate-drafts', expect.stringContaining(annotation.id));
    });
