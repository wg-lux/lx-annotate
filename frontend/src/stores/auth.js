...
export var useAuthStore = defineStore('auth', {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            this.loading = true;
                            this.error = null;
                            return [4 /*yield*/, axios.get('/user-status/')];
                        case 2:
                            response = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, axios.post('/accounts/logout/')];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
    ...
    getters: {
        username: function (state) { var _a; return ((_a = state.user) === null || _a === void 0 ? void 0 : _a.username) || ''; },
        userGroups: function (state) { var _a; return ((_a = state.user) === null || _a === void 0 ? void 0 : _a.groups) || []; },
        isLoading: function (state) { return state.loading; },
        hasError: function (state) { return state.error !== null; }
    },
});
