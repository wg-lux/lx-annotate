...
export declare const useExaminationStore: import('pinia').StoreDefinition<
  'examination',
  import('pinia')._UnwrapAll<
    Pick<
      {
        categoriesByExam: import('vue').Ref<
          Record<number, SubcategoryMap>,
          Record<number, SubcategoryMap>
        >
      ...
      'loading' | 'error' | 'categoriesByExam'
    >
  >,
  Pick<
    {
