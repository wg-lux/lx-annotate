...
export const useFindingStore = defineStore('finding', () => {
  ...
  const fetchFindingClassifications = async (
    findingId: number
  ...
  const fetchFindingsByPatientExamination = async (
    ...
    try {
      ...
      const response = await axiosInstance.get(
        `/api/patient-examinations/${patientExaminationId}/findings/`
      )
      findings.value = response.data.results || response.data
  ...
  const fetchExaminationClassifications = async (
