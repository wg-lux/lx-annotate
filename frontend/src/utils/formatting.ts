 ...
 */
export function formatDisplayName(item: { name?: string; name_de?: string; name_en?: string } | null | undefined): string {
 ...
 */
export function formatLocalizedName(item: LocalizedItem | null | undefined, fallback: string = 'Unbekannt'): string {
