...
const AnnotationDashboard_vue_1 = __importDefault(require("../components/Dashboard/AnnotationDashboard.vue"));
exports.default = (await Promise.resolve().then(() => __importStar(require('vue')))).defineComponent({
    name: 'Dashboard',
    components: {
        NavbarComponent: NavbarComponent_vue_1.default,
        SidebarComponent: SidebarComponent_vue_1.default,
        DashboardComponent: AnnotationDashboard_vue_1.default,
    },
});
