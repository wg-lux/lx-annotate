<template>
  <div class="merged-annotation-view">
    <div class="row">
      <div class="col-lg-7 col-12 mb-4">
        <!-- Patient Sensitive Meta Annotation (Form & Info) -->
...
import VideoAnnotation from '../components/EndoAI/VideoAnnotation.vue'
  ...
  <style scoped>
  /**** Merge both style blocks, keep both styles ****/
  /**** PatientSensitiveMetaVideoAnnotation styles ****/
  ...
  /**** VideoAnnotation styles (scoped, but you may want to prefix if needed) ****/
